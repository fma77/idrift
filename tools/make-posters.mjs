...
const CAR_SPRITES = [
  ...
  ["TOM's Supra.png", 'toms-gt500', 0],
  ['Supra Drift.png', 'drift-supra', 0],
];
...
// Garage hero images: 16:9, transparent, shipped at 960px wide -- twice the
// width a phone shows them at.
const CAR_HEROES = [
  ['Hachiroku hero.png', 'kaido-zen-r'],
  ['RX7 hero.png', 'onibi-silhouette'],
  ['Godzilla hero.png', 'tengu-gt-x'],
  ['Scooby hero.png', 'kaze-b4'],
  ['Yellowbird hero.png', 'yellowbird'],
  ['Silvia hero.png', 'silvia'],
  ['Hellcat hero.png', 'hellcat'],
  ["TOM's Supra hero.png", 'toms-gt500'],
  ['Supra Drift hero.png', 'drift-supra'],
];
